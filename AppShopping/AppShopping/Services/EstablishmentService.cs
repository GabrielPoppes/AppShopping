...
namespace AppShopping.Services
{
    ...
    {
        public List<Estabilishment> GetEstabilishments()
        {
            var establishmentList = new List<Estabilishment>()
            {
                new Estabilishment()
                {
                    Id = 1,
                    Tipo = EstablishmentType.Store,
                ...
                {
                    Id = 21,
                    Tipo = EstablishmentType.Restaurant,
